...
<div class="exform_wrapper call-us brdrad7 boxshdw">
 ...
 <form name="exform">
  ...
  <?php endif; ?>
    ...
    <div class="mf_clear"></div>
  <div class="mf_submit"><input type="submit" class="send_btn" onclick="ym(61915432, 'reachGoal', 'otpravka3'); return true;"  value="<?php echo $config->submit_title;?>"></div>
